...
from .views import Homepage, CriarConta, FuturasCompras, HomepageLogin, Saldo, recebimentos, Relatorios, EditarPerfil, despesas, saldoAtual, excluir_item_futuras_compras, criar_relatorio, relatorio_delete, ContasAVencerem, contasfuturas_delete
